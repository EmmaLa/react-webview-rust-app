...
},{"fbjs/lib/invariant":25,"fbjs/lib/warning":27,"./lib/ReactPropTypesSecret":44}],9:[function(require,module,exports) {
...
},{"object-assign":24,"fbjs/lib/invariant":25,"fbjs/lib/emptyObject":26,"fbjs/lib/warning":27,"fbjs/lib/emptyFunction":28,"prop-types/checkPropTypes":29}],5:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react.development.js":9}],30:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./isNode":52}],33:[function(require,module,exports) {
'use strict';
...
},{"./camelize":47}],10:[function(require,module,exports) {
/** @license React v16.3.2
...
},{"fbjs/lib/invariant":25,"react":5,"fbjs/lib/warning":27,"fbjs/lib/ExecutionEnvironment":30,"object-assign":24,"fbjs/lib/emptyFunction":28,"prop-types/checkPropTypes":29,"fbjs/lib/getActiveElement":31,"fbjs/lib/shallowEqual":32,"fbjs/lib/containsNode":33,"fbjs/lib/emptyObject":26,"fbjs/lib/hyphenateStyleName":34,"fbjs/lib/camelizeStyleName":35}],6:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react-dom.development.js":10}],43:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"fbjs/lib/emptyFunction":28,"fbjs/lib/invariant":25,"fbjs/lib/warning":27,"object-assign":24,"./lib/ReactPropTypesSecret":44,"./checkPropTypes":29}],36:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./factoryWithTypeCheckers":43}],16:[function(require,module,exports) {
'use strict';
...
},{"prop-types":36}],17:[function(require,module,exports) {
'use strict';
...
},{"react":5,"prop-types":36,"../utils/PropTypes":16,"../utils/warning":17}],41:[function(require,module,exports) {
var define;
...
},{"hoist-non-react-statics":41,"invariant":42,"react":5,"../utils/Subscription":18,"../utils/PropTypes":16}],19:[function(require,module,exports) {
'use strict';
...
},{"./ponyfill.js":58}],51:[function(require,module,exports) {
'use strict';
...
},{"symbol-observable":54}],67:[function(require,module,exports) {
var global = arguments[3];
'use strict';
...
},{"./_freeGlobal.js":67}],61:[function(require,module,exports) {
'use strict';
...
},{"./_root.js":65}],62:[function(require,module,exports) {
'use strict';
...
},{"./_Symbol.js":61,"./_getRawTag.js":62,"./_objectToString.js":63}],64:[function(require,module,exports) {
"use strict";
...
},{"./_overArg.js":64}],57:[function(require,module,exports) {
'use strict';
...
},{"./_baseGetTag.js":55,"./_getPrototype.js":56,"./isObjectLike.js":57}],49:[function(require,module,exports) {
'use strict';
...
},{"lodash-es/isPlainObject":53,"./warning":17}],48:[function(require,module,exports) {
'use strict';
...
},{"../utils/verifyPlainObject":49}],20:[function(require,module,exports) {
'use strict';
...
},{"redux":51,"./wrapMapToProps":48}],21:[function(require,module,exports) {
'use strict';
...
},{"./wrapMapToProps":48}],22:[function(require,module,exports) {
'use strict';
...
},{"../utils/verifyPlainObject":49}],50:[function(require,module,exports) {
'use strict';
...
},{"../utils/warning":17}],23:[function(require,module,exports) {
'use strict';
...
},{"./verifySubselectors":50}],13:[function(require,module,exports) {
'use strict';
...
},{"../components/connectAdvanced":12,"../utils/shallowEqual":19,"./mapDispatchToProps":20,"./mapStateToProps":21,"./mergeProps":22,"./selectorFactory":23}],7:[function(require,module,exports) {
'use strict';
...
},{"./components/Provider":11,"./components/connectAdvanced":12,"./connect/connect":13}],37:[function(require,module,exports) {
var bundleURL = null;
...
},{"./bundle-url":37}],8:[function(require,module,exports) {
...
},{"_css_loader":14}],60:[function(require,module,exports) {
"use strict";
...
var REFRESH_TODO = exports.REFRESH_TODO = "refresh_todo";
...
exports.refreshTodos = exports.updateTodo = exports.addTodo = undefined;

var _Todo = require('../../constants/Todo');

var rpc = {
    invoke: function invoke(arg) {
    ...
    clearDoneTasks: function clearDoneTasks() {
        rpc.invoke({ cmd: 'clearDoneTasks' });
    },
    markTask: function markTask(index, done) {
        rpc.invoke({ cmd: 'markTask', index: index, done: done });
    }
};

var addTodo = exports.addTodo = function addTodo(todoName) {
...
var updateTodo = exports.updateTodo = function updateTodo(index, done) {
    rpc.markTask(index, done);
    return {
        type: _Todo.UPDATE_TODO,
        done: done
    };
};

var refreshTodos = exports.refreshTodos = function refreshTodos(todos) {
    return {
        type: _Todo.REFRESH_TODO,
        todos: todos
    };
};
},{"../../constants/Todo":60}],66:[function(require,module,exports) {
"use strict";
...
var TodoItem = function (_React$Component) {
    ...
    function TodoItem(props) {
        ...
        _this.toggleTodoStatus = _this.toggleTodoStatus.bind(_this);
        return _this;
    }

    _createClass(TodoItem, [{
        key: "toggleTodoStatus",
        value: function toggleTodoStatus(event) {
            console.log(this.props);
            var todoIsDone = !this.props.todo.done;
        ...
        value: function render() {
            var markTodoClassName = this.props.todo.done ? "marked" : "";
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "span",
                    { onClick: this.toggleTodoStatus, className: markTodoClassName },
                    " ",
                    this.props.index,
                    " - ",
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        updateTodo: function updateTodo(index, done) {
            dispatch((0, _Todo.updateTodo)(index, done));
        }
    };
};

var TodoItemComponentProxy = (0, _reactRedux.connect)(null, mapDispatchToProps)(TodoItem);
    ...
    _createClass(TodoList, [{
        ...
        value: function render() {
            var todoItems = this.props.todos.map(function (todo, index) {
                return _react2.default.createElement(TodoItemComponentProxy, { key: todo.id, index: index, todo: todo });
            });
...
},{"react":5,"react-redux":7,"../../../actions/Todo":40}],39:[function(require,module,exports) {
"use strict";
...
var Todo = function (_React$Component) {
    ...
    function Todo(props) {
        ...
        console.log(props);
        _this.state = { newTodoValue: "" };

        _this.updateNewTodo = _this.updateNewTodo.bind(_this);
        _this.submitNewTodoOnEnter = _this.submitNewTodoOnEnter.bind(_this);
        return _this;
    }

    _createClass(Todo, [{
        key: "submitNewTodoOnEnter",
        value: function submitNewTodoOnEnter(event) {
        ...
        key: "updateNewTodo",
        value: function updateNewTodo(event) {
        ...
        value: function render() {
            return _react2.default.createElement(
                "div",
                null,
                _react2.default.createElement("input", { value: this.state.newTodoValue,
                ...
                _react2.default.createElement(
                    "span",
                    { "class": "button is-info delete-task-btn" },
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        addTodo: function addTodo(todoName) {
            dispatch((0, _Todo.addTodo)(todoName));
        }
    };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Todo);
},{"react":5,"react-redux":7,"../../actions/Todo":40,"./TodoList":66}],59:[function(require,module,exports) {
"use strict";
...
var rootReducer = function rootReducer() {
    ...
    switch (action.type) {
        case _Todo.REFRESH_TODO:
            console.log("REFRESH TODO");
            return action.todos;
        case _Todo.ADD_TODO:
            console.log("ADDING TODO");
            return state;
        case _Todo.UPDATE_TODO:
...
},{"../constants/Todo":60}],38:[function(require,module,exports) {
"use strict";
...
},{"redux":51,"../reducers":59}],2:[function(require,module,exports) {
"use strict";
...
var _Todo3 = require("./actions/Todo");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

window.refresh = function (todos) {
  console.log("Called refresh");
  _stores2.default.dispatch((0, _Todo3.refreshTodos)(todos));
};
...
},{"react":5,"react-dom":6,"react-redux":7,"bulma/css/bulma.css":8,"./css/index.scss":3,"./components/Todo":39,"./stores":38,"./actions/Todo":40}],69:[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/src.e735b7e7.map